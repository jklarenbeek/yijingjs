...
function bagua_flip(value = 0) {
  value = value | 0;
  return (value & 1) << 2 + (value & 2) + (value & 4) >> 2;
}
function bagua_invert(value = 0) {
  value = value | 0;
  return ((value & 7) ^ 7) & 7;
}
function bagua_lineCount(value = 0) {
  value = value | 0;
  return ((value & 1)
    + ((value >> 1) & 1)
    + ((value >> 2) & 1))|0;
}
function bagua_isAbstract(value = 0) {
  value = value | 0;
  return value === 0 || value === 7 || value === 5 || value === 2;
}

function bagua_toSixiang(value = 0) {
  value = value | 0;
  return (value >> 1) & 3;
}
function bagua_fromSixiang(value = 0) {
  value = value | 0;
  value &= 3;
...
function yijing_blue(value = 0) {
  value = value | 0;
  return (value & 3) | 0;
}

// get middle sixiang from hexagram
function yijing_white(value = 0) {
  value = value | 0;
  return ((value >> 2) & 3) | 0;
}

// get bottom sixiang from hexagram
function yijing_red(value = 0) {
  value = value | 0;
  return ((value >> 4) & 3) | 0; 
}

function yijing_toSixiang(value = 0) {
  return yijing_root(value) & 3;
}
function yijing_fromSixiang(value = 0) {
  switch(value) { 
     case 0: return 0; 
     case 1: return 21; 
     case 2: return 42;
...
function yijing_isRoot(value = 0) {
  value = value | 0;
...
function yijing_lineCount(value = 0) {
  value = value | 0;
  return (value & 1)
    + ((value >> 1) & 1)
    + ((value >> 2) & 1)
...
function yijing_symmetryGroups() {
...
function yijing_newFromSequence(src) {
...
const yijing_toKingWenSequence = Array.freeze(Array.seal([ 
...
const yijing_fromKingWenSequence = Array.freeze(Array.seal(
...
const yijing_toKingWenHousesSequence = Array.freeze(Array.seal([
...
function yijing_fromGray(/*unsigned short*/grayval) {
...
function yijing_toGray(binval) {
  binval = Math.abs(binval|0)|0;
  return ((binval >> 1) ^ binval) | 0;
}

const yijing_toGraySequence = Array.freeze(Array.seal((function () {
...
const yijing_fromGraySequence = Array.freeze(Array.seal(
...
export { bagua_flip, bagua_fromSixiang, bagua_invert, bagua_isAbstract, bagua_lineCount, bagua_toSixiang, yijing_blue, yijing_center, yijing_flip, yijing_fromGray, yijing_fromGraySequence, yijing_fromKingWen, yijing_fromKingWenSequence, yijing_fromSixiang, yijing_invert, yijing_isBalanced, yijing_isBeginning, yijing_isBreath, yijing_isCosmic, yijing_isDirection, yijing_isGigante, yijing_isKarmic, yijing_isMother, yijing_isPrinciple, yijing_isRoot, yijing_isTitan, yijing_lang, yijing_lineCount, yijing_lower, yijing_mantraName, yijing_newFromSequence, yijing_operatorSymbol, yijing_opposite, yijing_red, yijing_root, yijing_symmetryGroups, yijing_symmetryName, yijing_toGray, yijing_toGraySequence, yijing_toKingWen, yijing_toKingWenHousesSequence, yijing_toKingWenSequence, yijing_toSixiang, yijing_upper, yijing_white };
